package com.goribun.navie.server.utils;
...
import com.goribun.navie.core.constants.Const;
...
public class RPCServiceScanner {
    ...
    //默认包扫描路径
    private static final String DEFAULT_SCAN_PACKAGE = "cn.com.autohome.tuan.tuangou.service.*";
